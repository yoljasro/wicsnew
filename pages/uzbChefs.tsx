...
const UzbChefs: FC<any> = ({ props }) => {
  ...
  const localChefs: ChefData[] = [
    ...
    { nameuz: "Akhmad Khamdamov", image: "/assets/img/command2.png", instagram: "https://instagram.com/fathullakhan_?igshid=NDk5N2NlZjQ=", facebook: "https://www.facebook.com/fathulla.khan.796?mibextid=LQQJ4d", telegram: "@Fathullakhan_001", certificate: "/assets/documents/ahmad.pdf", },
    {
      nameuz: "Alieva Nodira",
      image: "/assets/img/uz1.jpg",
      instagram: "",
      facebook: "/",
      telegram: "/",
      certificate: "/assets/documents/razikov.pdf",
    ...
    {
      nameuz: "Saliyev Murodjon",
      image: "/assets/img/uz2.jpg",
      instagram: "",
      facebook: "/",
      telegram: "/",
      certificate: "/assets/documents/razikov.pdf",
    ...
    {
      nameuz: "Mahkamova Dildora",
      image: "/assets/img/uz3.jpg",
      instagram: "",
      facebook: "/",
      telegram: "/",
      certificate: "/assets/documents/razikov.pdf",
    ...
    {
        nameuz: "Hasan Hasanov",
      image: "/assets/img/uz4.jpg",
      instagram: "",
      facebook: "/",
      telegram: "/",
      certificate: "/assets/documents/razikov.pdf",
