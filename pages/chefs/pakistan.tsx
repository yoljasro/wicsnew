...
const Mala: FC<any> = ({ props }) => {
    const t = useTranslations();

    return (
        <div className={styles.cont}>
            <Head>
                <title>Mala Halal Chefs </title>
                <meta
                    name="description"
            ...
            <div className={styles.cont__chefs}>
                <div className={styles.cont__chefs__card}>
                    ...
                    <div className={styles.cont__chefs__card__hoverContent2}>
                        ...
                        <SocialNetworks
                            ...
                            telegram="/"
                        />
                        <a target={'_blank'} rel="noreferrer" href="/assets/documents/pak1.pdf">
                ...
                <div className={styles.cont__chefs__card}>
                    ...
                    <div className={styles.cont__chefs__card__hoverContent2}>
                        <h3> Mian Shahid Mahmood </h3>
                        <SocialNetworks
                            instagram="/"
                            facebook="/"
                            telegram="/"
                        />
                        <a target={'_blank'} rel="noreferrer" href="/assets/documents/pak2.pdf">
                            <Button className={styles.cont__certificateBtn} variant="contained">
                                {t("pageManufacturers.certificate")}
                            </Button>
                        </a>
